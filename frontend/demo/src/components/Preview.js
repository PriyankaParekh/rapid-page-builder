...
function Preview() {
    ...
    const editorHtml = location.state?.editorHtml; 
    ...
    const handleClick = () => {
        ...
        navigate("/addpage", { state: { formData, editorHtml } });
      };
...
<div
      ...
      >
        ...
        <div className="d-flex justify-content-center align-items-center ms-auto me-auto" style={{minHeight:"100vh", maxWidth:"90rem"}}>
        
            <div className="border p-5">
                <button className="btnReg mb-3" onClick={handleClick}>
                    Back 
             </button>
                <div className="blog">
                {/* https://sheknowsseo.co/wp-content/uploads/2022/12/laptop-digital-nomad-table.jpg */}
                    <img className='imgg mb-2' src={formData.attach[formData.attach.length-1]} alt="" />
                    ...
                    <p className='form-control mt-2'>Created By: {author}</p>
                    </div>    
            </div>
        </div>
    </div>
