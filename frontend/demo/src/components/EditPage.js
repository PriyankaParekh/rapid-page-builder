...
let img=JSON.parse(responseData.data.data[0].attach);
console.log(img);
      ...
      setSelectedFiles({
        base64: img[img.length-1], // Assuming img contains the base64 encoded image data
        name: "Image", // Provide a default name for the image
      });
  } catch (error) {
      console.log(error);
  }
